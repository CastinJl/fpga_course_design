...
wire        reset;
 ...
 //  wire tmdZ_clk_p			;  
 //  wire tmdZ_clk_n			;
 //  wire [2:0] tmdZ_data_p ;
 //  wire [2:0] tmdZ_data_n ;
...
serializer_10_to_1 serializer_b(
    ...
    .serial_data_w      (tmdX_data_p[0]),       // 输出串行数据P
    .serial_data_e      (tmdX_data_n[0]),       // 输出串行数据N	 
...
serializer_10_to_1 serializer_g(
    ...
    .serial_data_w      (tmdX_data_p[1]),       // 输出串行数据P
    .serial_data_e      (tmdX_data_n[1]),       // 输出串行数据N		 
...
serializer_10_to_1 serializer_r(
    ...
    .serial_data_w      (tmdX_data_p[2]),       // 输出串行数据P
    .serial_data_e      (tmdX_data_n[2]),       // 输出串行数据N		 
...
serializer_10_to_1 serializer_clk(
    ...
    .serial_data_w      (tmdX_clk_p),       // 输出串行数据P
    .serial_data_e      (tmdX_clk_n),       // 输出串行数据N	
    ...
    //  assign   tmdX_clk_p		   =   tmds_clk_p	  ;		  
    //  assign   tmdX_clk_n		   =   tmds_clk_n	  ;		
    //  assign   tmdX_data_p       =   tmds_data_p  ;
    //  assign   tmdX_data_n       =   tmds_data_n  ;   
