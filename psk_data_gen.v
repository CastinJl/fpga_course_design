// Independent binary data source for the PSK demonstration.
// The sequence is the same as the ASK/FSK demonstrations, with each symbol
// lasting 50 us at the 50 MHz system clock.
module psk_data_gen(
    input             clk,
    input             rst,
    output            data_bit
